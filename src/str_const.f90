...
character (len=40),parameter :: constraintA = 'Constrained solution'
...
character (len=60),parameter :: WgravA = 'Estimated gravities and gravimeter parameters'
character (len=60),parameter :: WgravF = 'Pesanteurs estimees'
...
character (len=60),parameter :: WmatricesA = 'Writing debug matrices '
character (len=60),parameter :: WmatricesF = 'Ecriture des matrices de deboggage'

character (len=40),parameter :: DOF_nullA = 'Degree Of Freedom = 0'
character (len=40),parameter :: DOF_nullF = 'Degre de liberte nul'
