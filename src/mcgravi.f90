...
!
! 3.1.1 09/05/2018 : 1. augmentation de la longueur maximale du nom de fichier html en sortie du calcul
...
character(len=40) function VERSION()
    ...
    character (len=40),parameter :: num_version='mcgravi 3.1.1  09/05/2018'
