...
real*8, parameter :: SD_min=0.000001D0
...
type TObsAbs
    ...
    integer numsta
    integer num_abs_file ! index of absolute obs file in Param%TabDataFic
    real*8 grav
    real*8 sd
end type TObsAbs

type (TObsAbs) ObsAbs
type (TObsAbs), allocatable, dimension(:) :: TabObsAbs,TabObsAbs2
...
!integer, allocatable, dimension(:) :: fichier, fichier2
...
type Tobs 
    character (len=8) nomsta
    real*8 grav,sd,tempK,mjd,Cf,h,grad
